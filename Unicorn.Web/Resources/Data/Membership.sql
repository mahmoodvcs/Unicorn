/**********************************************************************/
/* InstallCommon.SQL (and other scripts)                              */
/*                                                                    */
...
CREATE TABLE [dbo].[aspnet_UserRoleActions](
...
ALTER TABLE [dbo].[aspnet_UserRoleActions]  WITH CHECK ADD  CONSTRAINT [CK_aspnet_UserRoleActions] CHECK  (([ActionName] IS NOT NULL AND [UserRoleId] IS NOT NULL))
GO

ALTER TABLE [dbo].[aspnet_UserRoleActions] CHECK CONSTRAINT [CK_aspnet_UserRoleActions]
GO
...
CREATE FUNCTION fn_GetUserProfileElement
(
...
BEGIN
	...
	select @val = dbo.fn_GetProfileElement(@fieldName, p.PropertyNames, 
                      p.PropertyValuesString) from aspnet_Profile p inner join aspnet_users u
                      on p.UserID = u.UserID where u.loweredusername=lower(@userName)
   return @val
END
