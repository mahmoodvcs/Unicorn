...
using Jco.Web.Security.Configuration;
using System.Web.UI.HtmlControls;
using System.Configuration;
using System.Web.Configuration;
using Jco.Web.Controls;
using System.Web.Security;

namespace Jco.Web.Security.Pages
{
			...
			style1.InnerText = @"body, input, .style1
    {
		...
		Button uxOK;
		Jco.Web.Controls.CreateUserWizard uxCreateUser;
		Button uxBack;
		Label lbl;
		...
		protected void uxCreateUser_CreatedUser(object sender, EventArgs e)
		{
			if (!Roles.RoleExists("Admin"))
			{
				...
				lbl.Text = "نقش کاربری Admin با موفقیت ایجاد شد.";
			}
